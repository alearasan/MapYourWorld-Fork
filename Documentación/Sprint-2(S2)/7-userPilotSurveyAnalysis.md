...
- Para la encuesta en global, se asigna una nota basada en el porcentaje de apartados individuales exitosos o mejorables (que valdran la mitad) sobre el 100%, de tal forma que si por ejemplo el 70% son un exito, 20% mjorables y 10% fallo, la nota de la encuesta sera de 7(exito)+1(mejorable)=8. Se considera un éxito general si supera el 8, mejorable entre 5 y 8, y un fallo si está por debajo del 5.

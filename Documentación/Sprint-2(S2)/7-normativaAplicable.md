...
<h1 align="center">Normativa Aplicable</h1>
...
|---------|------------|-------------------------------|-------------------|
| V1      | 16/02/2025 | Primera versión               | Alba Ramos Vargas |
| V1.1    | 16/03/2025 | Conversión a .md y revisión  | Alba Ramos Vargas |

<!-- omit in toc-->
# Índice
- [Índice](#índice)
- [1. Nivel europeo](#1-nivel-europeo)
  - [1.1. Delegado de Protección de Datos](#11-delegado-de-protección-de-datos)
  - [1.2. Mantenimiento de registros](#12-mantenimiento-de-registros)
- [2. Nivel estatal](#2-nivel-estatal)
  - [2.1. Ley Orgánica de Protección de Datos Personales y Garantía de los Derechos Digitales](#21-ley-orgánica-de-protección-de-datos-personales-y-garantía-de-los-derechos-digitales)
  - [2.2. Ley Orgánica 7/2021](#22-ley-orgánica-72021)
- [3. Nivel autonómico](#3-nivel-autonómico)
  - [3.1. Transparencia](#31-transparencia)
  - [3.2. Protección de datos](#32-protección-de-datos)
- [4. Cómo nos afecta](#4-cómo-nos-afecta)

# 1. Nivel europeo

A nivel europeo existe el Reglamento General de Protección de Datos (RGPD)[^1^](https://eur-lex.europa.eu/legal-content/es/TXT/?uri=CELEX:32016R0679) [^2^](https://europa.eu/youreurope/business/dealing-with-customers/data-protection/data-protection-gdpr/index_es.htm) que nos afecta no sólo por ser un reglamento europeo sino porque al ser un marco normativo, todas las leyes de los estados miembros deben atenerse a este.

En el artículo 4 de este marco se definen los datos personales como:
...
A nivel estatal existe la Agencia Estatal de Protección de Datos (AEPD)[^3^](https://www.aepd.es/) que es, desde su consolidación original en 1992 ha sido la responsable de la normativa relacionada con la protección de datos.

La AEPD resalta en su página cuatro documentos[^4^](https://www.aepd.es/informes-y-resoluciones/normativa) en cuanto a la normativa relevante. Uno de ellos es el RGPD ya estudiado en el apartado anterior y otro es el Real Decreto que define la propia AEPD y sus responsabilidades[^8^](https://www.boe.es/buscar/pdf/2021/BOE-A-2021-9175-consolidado.pdf), por lo que no se considerarán ninguno de los dos en este nivel.

## 2.1. Ley Orgánica de Protección de Datos Personales y Garantía de los Derechos Digitales

La LOPDPGDD[^5^](https://www.boe.es/buscar/pdf/2018/BOE-A-2018-16673-consolidado.pdf) es la ley española que regula el tratamiento de los datos. Toma de referencia el marco establecido por el RGPD y lo especifica. Los artículos que más nos interesan de esta ley son:

- Artículo 5: que se refiere al artículo 5 del RGPD que dice que los datos personales serán:

> *tratados de tal manera que se garantice una seguridad adecuada de los datos personales, incluida la protección contra el tratamiento no autorizado o ilícito y contra su pérdida, destrucción o daño accidental, mediante la aplicación de medidas técnicas u organizativas apropiadas («integridad y confidencialidad»)*

Es decir, se debe crear un sistema seguro, además de monitorear cómo se tratan los datos a lo largo de su uso.
...
- Artículo 35: hace referencia a la cualificación del delegado de protección de datos, que necesitará acreditar "*conocimientos especializados en el derecho y la práctica en materia de protección de datos*" por lo que ninguno de nuestro equipo puede ser el DTD, habrá que contratar a alguien externo.

- Artículo 38: este artículo hace referencia a los códigos de conducta que se deben seguir, recogidos en la web de la AEPD[^6^](https://www.aepd.es/informes-y-resoluciones/codigos-de-conducta).

## 2.2. Ley Orgánica 7/2021
